...
The node first scans the template for placeholders in first-appearance order. It then looks up each referenced variable's candidate values and computes the Cartesian product across those value lists.
